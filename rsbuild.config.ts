...
console.log('🔍 [RSBuild Config] Environment Variables at Build Time:');
console.log('  APP_ENV:', process.env.APP_ENV);
console.log('  VERCEL_ENV:', process.env.VERCEL_ENV);
console.log('  CLIENT_ID:', process.env.CLIENT_ID ? `${process.env.CLIENT_ID.substring(0, 20)}...` : '❌ NOT SET');
