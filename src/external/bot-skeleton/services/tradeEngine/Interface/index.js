import { getExecutionSleepMultiplier } from '../../../constants/execution-speed-runtime';
...
const getSleepMultiplier = () => getExecutionSleepMultiplier();

const sleep = (observer, arg = 1) => {
    const delay_seconds = Math.max(0, Number(arg) || 0) * getSleepMultiplier();
