...
import ToolboxCategoryIcon from './toolbox-category-icon';
                ...
                <div id='gtm-toolbox' className='db-toolbox__content'>
                    <div className='db-toolbox__header'>
                        ...
                        >
                            ...
                            >
                                <LabelPairedChevronDownMdFillIcon fill='#ffffff' />
                            </span>
                        </div>
                    </div>
                    <div
                                            ...
                                            >
                                                ...
                                                >
                                                    <div className='db-toolbox__category-text'>
                                                        <ToolboxCategoryIcon
                                                            categoryName={category.getAttribute('name') as string}
                                                        />
                                                        ...
                                                        {has_sub_category && (
                                                            ...
                                                            >
                                                                <LabelPairedChevronDownMdFillIcon fill='#2749d8' />
                                                            </div>
                                                        )}
                                                    </div>
                                                </div>
