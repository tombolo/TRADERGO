(function () {
    ...
    function renderDevToolsBlockedScreen(doc) {
        ...
        screen.innerHTML =
            ...
            '<img class="devtools-blocked__logo" src="/assets/images/MERRICK.png" alt="SOFT TRADES" />' +
            ...
            '<p class="devtools-blocked__hint">Close developer tools, then refresh the page to continue using SOFT TRADES.</p>' +
